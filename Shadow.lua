...
end) -- Script taken from https://robloxscripts.com website --
...
-- Círculo FOV funcional usando Drawing nativo
...
FpsInput.FocusLost:Connect(function()
    ...
    if setfpscap then
        pcall(function()
            if num and num > 0 then setfpscap(num) else setfpscap(9999); FpsInput.Text = "9999" end
        end)
    end
end)
...
RunService.RenderStepped:Connect(function()
    -- Actualizar posición del círculo FOV con el mouse en tiempo real
